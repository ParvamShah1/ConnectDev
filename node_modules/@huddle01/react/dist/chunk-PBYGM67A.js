...
var require_common_validators = __commonJS({
  "../types/dist/validators/common.validators.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.VolatileDataMessageSchema = exports.PermissionSchema = exports.produceSourcesSchema = exports.RoomControlsSchema = exports.ActivePeersSchema = void 0;
    ...
    exports.RoomControlsSchema = zod_1.z.object({
...
var import_common = __toESM(require_common_validators(), 1);
...
var useActivePeers = () => {
  ...
  const handleSpeakerChange = useCallback(
    (data) => {
      const result = import_common.ActivePeersSchema.safeParse(data);
      if (result.success) {
...
//# sourceMappingURL=chunk-PBYGM67A.js.map