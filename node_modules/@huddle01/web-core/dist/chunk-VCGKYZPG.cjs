...
var _chunkFROPNK5Acjs = require('./chunk-FROPNK5A.cjs');
...
var logger = _chunkO5HDCTOEcjs.mainLogger.createSubLogger("DeviceHandler");
var CustomMediaKindToSystemKind = {
  cam: "videoinput",
  mic: "audioinput",
  speaker: "audiooutput"
};
var DeviceHandler = (_class = class extends _chunkAA6KQKWQcjs.EnhancedEventEmitter {constructor(...args) { super(...args); _class.prototype.__init.call(this);_class.prototype.__init2.call(this);_class.prototype.__init3.call(this);_class.prototype.__init4.call(this);_class.prototype.__init5.call(this);_class.prototype.__init6.call(this);_class.prototype.__init7.call(this);_class.prototype.__init8.call(this);_class.prototype.__init9.call(this);_class.prototype.__init10.call(this);_class.prototype.__init11.call(this);_class.prototype.__init12.call(this);_class.prototype.__init13.call(this);_class.prototype.__init14.call(this);_class.prototype.__init15.call(this); }
  __init() {this.SCREEN_DEFAULT_DEVICE = "monitor"}
  /**
   ...
   */
  __init2() {this.__preferredDevices = /* @__PURE__ */ new Map([
    ["cam", null],
    ["mic", null],
    ["speaker", null]
  ])}
   ...
   */
  __init3() {this.__mediaDevicesInfo = /* @__PURE__ */ new Map([
    ["cam", []],
    ["mic", []],
    ["speaker", []]
  ])}
   ...
   */
  __init4() {this.getMediaDevices = async (filterByDeviceKind, shouldFetchStream = false) => {
    logger.info("\u{1F4F9} Fetching Media Devices");
    let constraints;
    if (filterByDeviceKind === "speaker" || filterByDeviceKind === "device-change") {
      constraints = _chunkFROPNK5Acjs.deviceConstraints_default.mic;
    } else if (filterByDeviceKind) {
      constraints = _chunkFROPNK5Acjs.deviceConstraints_default[filterByDeviceKind];
    } else {
      constraints = {
        ..._chunkFROPNK5Acjs.deviceConstraints_default.mic,
        ..._chunkFROPNK5Acjs.deviceConstraints_default.cam
      };
    }
    let devices = [];
   ...
   * `NOTE`: Ask for MediaDevice Permission to get the right result for that device else it will return `null`
   */
  __init5() {this.getDeviceFromFacingMode = (facing, mediaDeviceKind) => {
  ...
  __init6() {this.setPreferredDevice = (data) => {
   ...
   * @returns
   */
  __init7() {this.fetchScreen = async () => {
    const constraints = _chunkFROPNK5Acjs.deviceConstraints_default.screen;
    try {
   ...
   *
   */
  __init8() {this.fetchStream = async (data) => {
    ...
    try {
      ...
      const { stream, deviceId } = await fetchStreamFunc({
        deviceId: _nullishCoalesce(preferredDeviceId, () => ( void 0)),
  ...
  __init9() {this.fetchStreamByGroupId = async (data) => {
    let constraints;
   ...
   */
  __init10() {this.__fetchStreamFromDeviceForRN = async (data) => {
    const constraints = _chunkFROPNK5Acjs.deviceConstraints_default[data.mediaKind];
    let facingMode;
   ...
   * @returns - { stream: MediaStream, deviceId: string }
   */
  __init11() {this.__fetchStreamFromDeviceForWeb = async (data) => {
    const constraints = Object.assign(
      {},
      _chunkFROPNK5Acjs.deviceConstraints_default[data.mediaKind]
    );
   ...
   */
  __init12() {this.getMediaPermission = async (data) => {
  ...
  __init13() {this.stopStream = (stream) => {
    if (!stream)
      return;
   ...
   */
  __init15() {this.__setMediaDeviceInfo = (data) => {
...
exports.DeviceHandler_default = DeviceHandler_default;
