...
import RemotePeer from './RemotePeer.cjs';
import { NewPeerJoined } from './types/common.types.cjs';
import { z } from 'zod';
import ActiveSpeakers from './ActiveSpeakers.cjs';
...
declare class Room extends EnhancedEventEmitter<RoomEvents> {
     ...
     */
    private __activeSpeakers;
    /**
     * Get the active speakers instance
     */
    get activeSpeakers(): ActiveSpeakers | null;
    set activeSpeakers(activeSpeakers: ActiveSpeakers);
    /**
     * State of the Room
     */
    private __state;
...
export { NewRoomControls as N, ProduceSources as P, Room as R, TPermissions as T, RoomEvents as a, RoomStates as b, RoomInfo as c, RoomControls as d, RoomStats as e };
