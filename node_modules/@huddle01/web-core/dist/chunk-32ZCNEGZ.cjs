...
var _chunk4TRX7GZ6cjs = require('./chunk-4TRX7GZ6.cjs');
...
var _chunk6NBFY44Hcjs = require('./chunk-6NBFY44H.cjs');
...
var _chunk3S34XHJLcjs = require('./chunk-3S34XHJL.cjs');


var _chunkYOUFZVOYcjs = require('./chunk-YOUFZVOY.cjs');


var _chunkVCGKYZPGcjs = require('./chunk-VCGKYZPG.cjs');
...
var logger = _chunkO5HDCTOEcjs.mainLogger.createSubLogger("LocalPeer");
var MAX_DATA_MESSAGE_SIZE = 1 * 1024;
var LocalPeer = (_class = class _LocalPeer extends _chunkAA6KQKWQcjs.EnhancedEventEmitter {
  /**
   ...
   */
  get room() {
    const room = _chunkVLUFOOD3cjs.Room_default.getInstance();
    if (!room)
   ...
   */
  get socket() {
    const socket = _chunkCRVOHRUMcjs.Socket_default.getInstance();
    if (!socket)
  ...
  __init6() {this.__pendingConsumerTasks = /* @__PURE__ */ new Map()}
  // !important
  ...
  __init7() {this.__pendingProducerTasks = /* @__PURE__ */ new Map()}
  // !important
  // Map to store pending tasks, Stores the label and the promise of the task
  __init8() {this.__pendingTasks = /* @__PURE__ */ new Map()}
  /**
   ...
   */
  __init9() {this.__pendingTransportTasks = /* @__PURE__ */ new Map()}
  /**
   ...
   */
  __init10() {this.__pendingFetchingStream = /* @__PURE__ */ new Map()}
  /**
   ...
   * @param metadata
   */
  __init19() {this.__updateMetadata = (metadata) => {
   ...
   */
  __init20() {this.getProducerWithLabel = (label) => {
    try {
      const producerId = _optionalChain([this, 'access', _28 => _28.__sendTransport, 'optionalAccess', _29 => _29.labelToProducerId, 'access', _30 => _30.get, 'call', _31 => _31(label)]);
      if (producerId) {
   ...
   */
  __init21() {this.__registerHandlerEvents = (socket) => {
    let cnt = 0;
   ...
   * @param transportType
   */
  __init22() {this.transportExists = (transportType) => {
  ...
  __init23() {this.close = () => {
    ...
    this.emit("permissions-updated", {
      ...
      role: _nullishCoalesce(this.role, () => ( ""))
    });
  }}
  /**
   ...
   */
  __init24() {this.produce = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    canProduce: true
  }).validate(
    async (data) => {
      ...
      if (!this.joined || this.__sendTransport && _optionalChain([this, 'access', _32 => _32.__sendTransport, 'optionalAccess', _33 => _33.connectionState]) !== "connected") {
   ...
   */
  __init25() {this.enableVideo = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    canProduce: true
   ...
   *
   */
  __init26() {this.startScreenShare = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, { canProduce: true }).validate(
    async () => {
      try {
        ...
        const videoTrack = _optionalChain([stream, 'access', _34 => _34.getVideoTracks, 'call', _35 => _35(), 'optionalAccess', _36 => _36[0]]);
        const audioTrack = _optionalChain([stream, 'access', _37 => _37.getAudioTracks, 'call', _38 => _38(), 'optionalAccess', _39 => _39[0]]);
   ...
   * and they should stop consuming it.
   */
  __init27() {this.enableAudio = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    canProduce: true
   ...
   */
  __init28() {this.stopProducing = (data) => {
    ...
    if (producer) {
      ...
      _optionalChain([this, 'access', _40 => _40.__sendTransport, 'optionalAccess', _41 => _41.removeProducerById, 'call', _42 => _42(producer.id)]);
      closedStream = true;
   ...
   * @param data Data to stop producing { label: string }
   */
  __init29() {this.disableVideo = async () => {
    this.stopProducing({
      label: "video"
    });
  }}
   ...
   */
  __init30() {this.replaceVideoStream = async (stream) => {
   ...
   * @param deviceId
   */
  __init31() {this.changeVideoSource = async (deviceId) => {
   ...
   *
   */
  __init32() {this.replaceAudioStream = async (stream) => {
    await this.replaceStream({
      label: "audio",
      newStream: stream
    });
   ...
   */
  __init33() {this.replaceStream = async (data) => {
    ...
    const mediaDeviceKind = _chunkXHHWH5ENcjs.getMediaDeviceKind.call(void 0, track);
    this.emit("stream-fetched", {
      label: data.label,
   ...
   * @param deviceId
   */
  __init34() {this.changeAudioSource = async (deviceId) => {
    this.deviceHandler.setPreferredDevice({
      deviceId,
      deviceKind: "mic"
    });
   ...
   * `NOTE: This will notify all the RemotePeers that this producer has stopped producing and they should stop consuming it.`
   */
  __init35() {this.disableAudio = async () => {
    this.stopProducing({
      label: "audio"
    });
  }}
   ...
   * `NOTE: This will notify all the RemotePeers that this producer has stopped producing and they should stop consuming it. if you have joined the room, else it will just close the stream`
   */
  __init36() {this.stopScreenShare = async () => {
    try {
      this.stopProducing({
        label: "screen-share-video"
      });
   ...
   *
   */
  __init37() {this.consume = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    canConsume: true
  }).validate(
    async (data) => {
      ...
      if (_optionalChain([consumerExists, 'optionalAccess', _43 => _43.consuming])) {
      ...
      const pendingPromise = this.__pendingConsumerTasks.get(
        _optionalChain([labelData, 'optionalAccess', _44 => _44.producerId])
      );
      if (pendingPromise) {
        logger.warn(
   ...
   * @param data
   */
  __init38() {this.stopConsuming = (data) => {
    const remotePeer = this.room.getRemotePeerById(data.peerId);
   ...
   */
  __init39() {this.activateActiveSpeakersNotification = async (size) => {
    try {
      logger.info("\u{1F514} Activating Speakers Notification Functionality");
      if (this.room.activeSpeakers) {
        logger.info("\u{1F514} Speakers Notification Functionality Already Activated");
        return;
      }
      const botDataConsume = _optionalChain([this, 'access', _45 => _45.__sendTransport, 'optionalAccess', _46 => _46.dataConsumers, 'access', _47 => _47.get, 'call', _48 => _48("bot")]);
      if (botDataConsume) {
      ...
      if (ongoingActiveSpeakerPromise) {
        ...
        const fn = async () => {
          ...
          return _nullishCoalesce(size, () => ( 8));
        };
        const promise = fn();
  ...
  __init40() {this.sendData = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    canSendData: true
  }).validate(
    (data) => {
      if (_chunkXHHWH5ENcjs.estimateSize.call(void 0, data.payload) > MAX_DATA_MESSAGE_SIZE) {
   ...
   */
  __init42() {this.updateMetadata = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
  ...
  __init44() {this.__handler = {
    ...
    hello: (data) => {
      ...
      if (_optionalChain([data, 'optionalAccess', _49 => _49.role]))
    ...
    connectRoomResponse: async (data) => {
      ...
      try {
        ...
        this.room.metadata = _nullishCoalesce(roomInfo.metadata, () => ( "{}"));
        this.room.stats.startTime = roomInfo.startTime;
        const deviceType = _mediasoupclient.detectDevice.call(void 0, );
        if (!deviceType) {
          logger.error(
        ...
        this.__device = new (0, _mediasoupclient.Device)({ handlerName: deviceType });
        const parsedRouterRtpCapabilites = _chunkY4HA25UMcjs.parseRouterRtpCapabilities.call(void 0, {
        ...
        if (_optionalChain([turnServers, 'optionalAccess', _50 => _50.length])) {
    ...
    createTransportOnClient: async (data) => {
      try {
        ...
        const transport = _chunk4TRX7GZ6cjs.Transport_default.create({
          device,
          peerId: this.peerId,
          socket: this.socket,
    ...
    produceResponse: async (data) => {
      ...
      try {
        ...
        if (!producerId || !label || !peerId) {
          logger.error("\u274C ProducerId or Label or PeerId Not Found");
          return;
        }
    ...
    consumeDataResponse: async (data) => {
      logger.debug("\u2705 Consume Data Response, label", data.label);
      try {
        const {
          id,
          peerId,
        ...
        if (label !== "bot") {
          logger.warn("\u{1F514} Consume Data Response, label is not bot, returning");
          return;
        }
        if (label === "bot") {
          ...
          const bot = _chunkYOUFZVOYcjs.Bot_default.getInstance();
          ...
          if (!activeSpeakers) {
            this.room.activeSpeakers = _chunk6NBFY44Hcjs.ActiveSpeakers_default.createInstance({
              bot,
              size
            });
          }
    ...
    produceDataResponse: async (data) => {
      logger.debug("\u2705 Produce Data Response consumerIdFromServer", data.id);
      try {
        const {
          id,
          peerId,
        ...
        dataConsumer.on("message", (message) => {
          ...
          const result = _chunk3S34XHJLcjs.VolatileDataMessageSchema.safeParse(parsedJsonData);
          if (result.success) {
    ...
    newPeerRole: (data) => {
      ...
      try {
        ...
        const remotePeer = this.room.getRemotePeerById(peerId);
        const prevRole = _nullishCoalesce(remotePeer.role, () => ( ""));
    ...
    roomClosedProducers: (data) => {
      ...
      try {
        ...
        this.room.emit("room-notification", {
          code: _nullishCoalesce(_optionalChain([reason, 'optionalAccess', _51 => _51.code]), () => ( 4004)),
          message: _nullishCoalesce(_optionalChain([reason, 'optionalAccess', _52 => _52.message]), () => ( "Room Closed")),
          tag: _nullishCoalesce(_optionalChain([reason, 'optionalAccess', _53 => _53.tag]), () => ( "ROOM_CLOSED"))
        });
      } catch (error) {
  ...
  __init46() {this.__createTransportOnServer = async (data) => {
   ...
   * @param roomInfo
   */
  __init47() {this.__setRemotePeers = (roomInfo) => {
   ...
   */
  __init48() {this.__setLobbyPeers = (roomInfo) => {
   ...
   */
  __init49() {this.__closeRemotePeerConsumer = (data) => {
    try {
      const { peerId, label } = data;
      const remotePeer = this.room.getRemotePeerById(peerId);
      const consumer = this.recvTransport.getConsumer({
   ...
   */
  __init50() {this.__handleWaitingToProduce = () => {
    try {
  ...
  __init51() {this.__handleWaitingToConsume = () => {
...
// src/RemotePeer.ts
var logger2 = _chunkO5HDCTOEcjs.mainLogger.createSubLogger("RemotePeer");
var RemotePeer = (_class2 = class extends _chunkAA6KQKWQcjs.EnhancedEventEmitter {
  /**
   ...
   */
  __init55() {this.updatePermissions = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    admin: true
  }).validate(async (data) => {
    try {
   ...
   * Update the role of the Remote Peer in the Room, this will emit an event `updated` with the updated role.
   */
  __init56() {this.updateRole = _chunkUL4JRY5Xcjs.checkPermissions.call(void 0, {
    admin: true
  }).validate((data) => {
    try {
  ...
  constructor(data) {
    super();_class2.prototype.__init52.call(this);_class2.prototype.__init53.call(this);_class2.prototype.__init54.call(this);_class2.prototype.__init55.call(this);_class2.prototype.__init56.call(this);_class2.prototype.__init57.call(this);_class2.prototype.__init58.call(this);_class2.prototype.__init59.call(this);;
   ...
   */
  __init58() {this._addLabelData = async (data) => {
    const { label, producerId } = data;
    this.__labelsToProducerId.set(label, { producerId });
    try {
      const autoConsume = _chunkVLUFOOD3cjs.Room_default.getInstance().autoConsume;
      const localPeer = LocalPeer_default.getInstance();
      if (autoConsume) {
        logger2.debug(
   ...
   */
  __init59() {this._removeLabelData = (label, reason) => {
...
exports.RemotePeer_default = RemotePeer_default; exports.LocalPeer_default = LocalPeer_default;
