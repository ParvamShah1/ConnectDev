...
var _chunkSWMYVWWMcjs = require('./chunk-SWMYVWWM.cjs');
...
var require_socket_types = _chunk4FMC7UH2cjs.__commonJS.call(void 0, {
...
var require_rtp_capabilities_pb = _chunk4FMC7UH2cjs.__commonJS.call(void 0, {
  "../protoc/dist/rtc/rtp_capabilities_pb.js"(exports) {
    ...
    var protobuf_1 = (_chunkMGUCXW7Mcjs.init_esm.call(void 0, ), _chunk4FMC7UH2cjs.__toCommonJS.call(void 0, _chunkMGUCXW7Mcjs.esm_exports));
...
var require_response_pb = _chunk4FMC7UH2cjs.__commonJS.call(void 0, {
  "../protoc/dist/client/response_pb.js"(exports) {
    ...
    var protobuf_1 = (_chunkMGUCXW7Mcjs.init_esm.call(void 0, ), _chunk4FMC7UH2cjs.__toCommonJS.call(void 0, _chunkMGUCXW7Mcjs.esm_exports));
    var permissions_pb_js_1 = _chunkSWMYVWWMcjs.require_permissions_pb.call(void 0, );
    var rtp_capabilities_pb_js_1 = require_rtp_capabilities_pb();
    var sdp_info_pb_js_1 = _chunkSWMYVWWMcjs.require_sdp_info_pb.call(void 0, );
    var app_data_pb_js_1 = _chunkSWMYVWWMcjs.require_app_data_pb.call(void 0, );
    var sctp_stream_parameters_pb_js_1 = _chunkSWMYVWWMcjs.require_sctp_stream_parameters_pb.call(void 0, );
    var rtp_parameters_pb_js_1 = _chunkMGUCXW7Mcjs.require_rtp_parameters_pb.call(void 0, );
...
// src/Socket.ts
var import_socket = _chunk4FMC7UH2cjs.__toESM.call(void 0, require_socket_types(), 1);
var import_request_pb = _chunk4FMC7UH2cjs.__toESM.call(void 0, _chunkSWMYVWWMcjs.require_request_pb.call(void 0, ), 1);
var import_response_pb = _chunk4FMC7UH2cjs.__toESM.call(void 0, require_response_pb(), 1);
var logger = _chunkO5HDCTOEcjs.mainLogger.createSubLogger("Socket.ts");
var Socket = (_class = class _Socket extends _chunkAA6KQKWQcjs.EnhancedEventEmitter {
  /**
   ...
   *
   */
  __init9() {this.__getRegion = async () => {
    const resp = await fetch(
      "https://shinigami.huddle01.com/api/get-geolocation"
    );
    const data = await _optionalChain([resp, 'optionalAccess', _3 => _3.json, 'call', _4 => _4()]);
    const geolocationdata = _chunk3S34XHJLcjs.GeolocationSchema.safeParse(data);
   ...
   */
  __init11() {this.connect = async (data) => {
    if (!_Socket.__instance) {
   ...
   */
  __init13() {this.publish = (event, data) => {
    try {
      const message = new import_request_pb.Request({
        request: {
          case: event,
          value: new _chunkSWMYVWWMcjs.ProtoRequestEvent[event](data)
        }
      });
   ...
   */
  __init14() {this.subscribe = (event, fn) => {
   ...
   */
  __init15() {this.__handleIncomingMessage = (event) => {
    try {
  ...
  __init16() {this.__handleSocketError = (ev) => {
   ...
   * @param ev CloseEvent
   */
  __init17() {this.__handleSocketClose = (ev) => {
   ...
   * @param ev Event
   */
  __init18() {this.__handleSocketOpen = (ev) => {
   ...
   * @param ws WebSocket
   */
  __init19() {this.__registerSocketEvents = (ws) => {
   ...
   * @param ws WebSocket
   */
  __init20() {this.__unregisterSocketEvents = (ws) => {
...
exports.require_socket_types = require_socket_types; exports.Socket_default = Socket_default;
